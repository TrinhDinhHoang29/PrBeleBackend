                    ...
                    new Rate
        {
            ...
            if (!_context.blogs.Any())
            {
                List<Blog> blogs = new List<Blog>()
                {
                    new Blog
                    {
                        ...
                        Contents = new List<BlogContent>()
                        {
                            new BlogContent
                            {
                                ...
                                ContentType = "Image",
                                ContentText = "",
                                ImageUrl = "https://res.cloudinary.com/dwewnjnbm/image/upload/v1737017610/bele/blog/logo_slogan_gmylkw.jpg",
                                Order = 1
                            },
                            new BlogContent
                            {
                                Title = "",
                                ContentType = "Text",
                                ContentText = "Là 1 thương hiệu thời trang nam hàng đầu, chuyên cung cấp các mặt hàng về thể thao với chất lượng cao cấp, hiện đại, và đầy phong cách. Khoác lên mình sản phẩm của Bele, để cảm nhận sự khác biệt đến rất tuyệt. Sự thoải mái, đơn giản và tiện lợi.<br> Chúng tôi sở hữu các mặt hàng đã dạng từ áo thun, áo sơ mi, quần jeans, quần short, phụ kiện,... Với số lượng mặt hàng siêu đa dạng, hi vọng sẽ phù hợp với sở thích cỉa khách hàng.<br> Tên công ty: Bele Co., Ltd <br> Address: 123 ABC, quận 1, thànhh phố Hồ Chí Minh, Việt Nam <br> Website: www.bele.com.vn<br> Hotline: 1900 1234 <br> Email: support@bele.com.vn",
                                ImageUrl = "",
                                Order = 2
                            },
                            new BlogContent
                            ...
                            new BlogContent
                            {
                                ...
                                ContentType = "Text",
                                ContentText = "Với những sản phẩm bạn đã mua tại Bele, 60 ngày kể từ khi bạn nhận sản phẩm, bạn sẽ được đổi hàng và trả hàng với bất kỳ lý do gì, tối đa 3 lần/đơn đến khi ưng ý, bao gồm cả các sản phẩm đã qua giặt và sử dụng.",
                                ImageUrl = "",
                                Order = 4
                            },
                            new BlogContent
                            {
                                ...
                                ContentType = "Image",
                                ContentText = "",
                                ImageUrl = "https://res.cloudinary.com/dwewnjnbm/image/upload/v1737023823/bele/blog/policy-1_r2gctl.jpg",
                                Order = 5
                            },
                            new BlogContent
                            {
                                Title = "2. Chính sách khuyến mãi",
                                ContentType = "Text",
                                ContentText = "Với những chương trình khuyến mãi hấp dẫn vào các dịp lễ tết, có thêm các chương trình săn voucher giảm giá cực hấp dẫn.",
                                ImageUrl = "",
                                Order = 6
                            },
                            new BlogContent
                            {
                                ...
                                ContentType = "Image",
                                ContentText = "",
                                ImageUrl = "https://res.cloudinary.com/dwewnjnbm/image/upload/v1737023823/bele/blog/policy-2_aicahw.jpg",
                                Order = 7
                            },
                            new BlogContent
                            {
                                ...
                                ContentType = "Text",
                                ContentText = "Chúng tôi cam kết sẽ bảo mật các thông tin cá nhân của khách hàng và bao gồm các mục đích thu nhập, phạm vi thu nhập.<br>Khách hàng có thể yêu cầu xóa và chỉnh sửa thông tin cá nhân<br> Chúng tôi luôn đảm bảo an toàn dự liệu của khách hàng và đối với cả bên thứ 3.",
                                ImageUrl = "",
                                Order = 8
                            },
                            new BlogContent
                            {
                                ...
                                ContentType = "Image",
                                ContentText = "",
                                ImageUrl = "https://res.cloudinary.com/dwewnjnbm/image/upload/v1737023823/bele/blog/policy-3_usquan.png",
                                Order = 9
                            },
                            new BlogContent
                            {
                                ...
                                ContentType = "Text",
                                ContentText = "Giao hàng nhanh và đúng hẹn cho 95% đơn hàng là mục tiêu mà đội ngũ vận hành của Bele hướng tới. Khách hàng hãy tin ở Bele, chúng tôi sẽ làm được! <br> LƯU Ý: Trong trường hợp khách hàng cần nhận hàng gấp thì có thể liên hệ Hotline Bele 19001234 để được hỗ trợ. Bele không cam kết có thể hỗ trợ các trường hợp khẩn cấp 100%, tuy nhiên Bele chắc chắn sẽ làm mọi cách có thể để giúp khách hàng giải quyết công việc của mình.",
                                ImageUrl = "",
                                Order = 10
                            },
                            new BlogContent
                            {
                                ...
                                ContentType = "Image",
                                ContentText = "",
                                ImageUrl = "https://res.cloudinary.com/dwewnjnbm/image/upload/v1737023823/bele/blog/policy-4_hvt1im.png",
                                Order = 11
                            },
                        }
                    },
                    ...
                    new Blog
                    {
                        Title = "Bí kíp tạo dáng chụp ảnh nam đẹp ngầu như mẫu nam Hàn Quốc - version 2",
                        Status = 1,
                        Deleted = 0,
                        CreatedAt = DateTime.Now.ToString(),
                        Contents = new List<BlogContent>()
                    ...
                    new Blog
                    {
                        Title = "Bí kíp phối đồ tập gym nam cực chất lại thoải mái cho chàng - version 2",
                        Status = 1,
                        Deleted = 0,
                        CreatedAt = DateTime.Now.ToString(),
                        Contents = new List<BlogContent>()
